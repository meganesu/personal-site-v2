...
I finished my first side project! It's an [interactive Game Boy opcode table](https://meganesu.github.io/generate-gb-opcodes/). I started it last July and worked on it sporadically through March. I wrote a blog post with more details: [Meet the Game Boy Instruction Set](/blog/game-boy-opcodes).
