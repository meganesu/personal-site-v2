...
The authors also created an [Understanding by Design Professional Development Workbook](https://shop.ascd.org/PersonifyEbusiness/Store/Product-Details/ProductId/411), which has lots of examples of putting the framework into practice. It also includes several worksheets that you can use to apply the process to your own courses.
