...
One example of an information architecture that you can use to organize your documentation is the [Diátaxis framework](https://diataxis.fr/) by Daniele Procida. (This is what the [Gatsby docs structure](https://www.gatsbyjs.com/blog/announcing-new-gatsby-docs-site/) is based on).
...
For example, after we reorganized the Gatsby docs to use the Diátaxis framework, we adjusted the site's design to reflect the new information architecture.
