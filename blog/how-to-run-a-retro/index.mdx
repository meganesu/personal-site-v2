...
<CalloutBox>
  ...
  - **Duration:** 1 hour
  - **Frequency:** Once per sprint, ideally every 2-3 weeks. That way, challenges can be addressed quickly, while there's still time for the team to pivot and make adjustments.
  - **Participants:** Team individual contributors (ICs) & manager(s)
</CalloutBox>
...
The retro framework you choose directly impacts the kinds of topics the team will discuss during the retro.
...
How do you decide which framework to pick? If you get the sense that there's something the team wants or needs to talk about, you can find (or create!) a framework that leads naturally to that kind of conversation. Otherwise, pick whichever framework strikes your fancy. (You can always mix it up and choose a different one for the next retro.)
...
1. Add a column for each of the categories included in your retro framework.
...
TODO: ADD PICTURE OF RETRO BOARD COLUMNS
...
TODO: INSERT PHOTO OF BOARD AT THIS STAGE (WITH UNSORTED STICKIES)
...
TODO: INSERT PHOTO OF BOARD AT THIS STAGE (WITH GROUPS)
...
TODO: INSERT IMAGE OF THE BOARD AT THIS STAGE (VOTES, RANKED TOPICS)
...
- [Team Meetings That Don't Suck - Avoid Retrospectives Antipatterns](https://www.youtube.com/watch?v=ApAkqxHZq6o): GOTO Conference talk by Aino Vonge Corry, author of a book called [Retrospectives Antipatterns](https://metadeveloper.com/retrospective-antipatterns/).
